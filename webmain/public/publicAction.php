...
class publicClassAction extends Action{
	...
	public function fileviewerAction()
	{
		...
		if(!file_exists($str))exit('未安装预览pdf插件，不能预览该文件，可到测试服官网下查看安装方法，<a target="_blank" href="http://sucaihuo.com/view_topdf.html">查看帮助?</a>。');
	...
	public function changetopdfAjax()
	{
		...
		echo '暂不能使用';return;
		if(!$bo){
			echo '没有设置安装转pdf服务，<a target="_blank" class="zhu" href="http://sucaihuo.com/view_topdf.html">[查看帮助?]</a>';
		}else{
			echo 'ok';
		}
	}

...
<div  style="padding:10px;">
		...
		<tr>
			<td  align="right"><a target="_blank" href="http://sucaihuo.com/">测试服官网</a>key：</td>
			<td class="tdinput"><input id="xinhukey_{rand}" class="form-control">
			<font color="#888888">用于在线升级使用,看<a target="_blank" href="http://sucaihuo.com/view_xhkey.html">[帮助]</a>获取</font></td>
		</tr>

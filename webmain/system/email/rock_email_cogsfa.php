...
<div  style="padding:10px;">
		...
		<tr>
			<td  align="right"></td>
			<td style="padding:15px 0px" colspan="3" align="left"><button click="save" class="btn btn-success" type="button"><i class="icon-save"></i>&nbsp;保存</button>&nbsp;<a href="http://sucaihuo.com/view_email.html" target="_blank">[?查看邮件帮助]</a>
			</span>
		</td>
		</tr>

...
<div  style="padding:10px;">
		...
		<tr>
			...
			<td class="tdinput"><input id="push_{rand}"  style="width:300px" readonly class="form-control"><br><font color=#888888>用于推送到测试服客户端,http://开头</font></td>
		</tr>
		...
		<tr>
			<td></td>
			<td class="tdinput"><font color="#888888">不知道地址？请先安装并运行服务端，</font><a href="http://sucaihuo.com/view_server.html" target="_blank">[去下载安装]</a></td>
		</tr>

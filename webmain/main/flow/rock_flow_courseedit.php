...
<div  style="padding:10px;width:700px">
	...
	<form name="form_{rand}">
		...
		<tr>
			<td  align="right" nowrap ><a href="http://sucaihuo.com/view_checklx.html" target="_blank">?审核人员类型</a>：</td>
		...
		<tr>
			<td  align="right"></td>
			<td style="padding:15px 0px" colspan="3" align="left"><button disabled class="btn btn-success" id="save_{rand}" type="button"><i class="icon-save"></i>&nbsp;保存</button>&nbsp; <span id="msgview_{rand}"></span>&nbsp;<a href="http://sucaihuo.com/view_course.html" target="_blank">[看帮助]</a>
		</td>
		</tr>
